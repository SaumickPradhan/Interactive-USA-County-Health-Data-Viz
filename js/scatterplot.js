...
handleMouseOut = () => {
  ...
  handleMouseDown(event) {
    ...
    //     .attr("cy", (d) => vis.yScale(d[vis.attribute1]))
    //     .attr("r", 2)
    //     .style("fill", `color-mix(in srgb, ${attributes[vis.attribute1].color}, ${attributes[vis.attribute2].color}`)
    //     .style("fill-opacity", (d) => {
    //       if ( countyFilter.length !== 0) {
    //         if (
    //            countyFilter.find(
    ...
    //   // Select all circle.regularPoint elements
    //     d3.selectAll("circle.regularPoint")
